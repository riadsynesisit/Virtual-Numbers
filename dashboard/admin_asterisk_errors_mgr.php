<?php
    ...
    function get_page_content($this_page)
    {
        ...
        $my_total_call_count    =   mysql_fetch_object(mysql_query("SELECT count(*) as total FROM cdr WHERE disposition NOT LIKE 'ANSWERED'"))->total;
        ...
        $cdr_set=   $cdrs->asterisk_errors($_SESSION['user_logins_id'], $records_per_page, $page_current_range_start - 1);
        $my_cdrs=   array();
        ...
        $this_page->content_area.=  getAsteriskErrorPage();//In pages/call_records.inc.php
