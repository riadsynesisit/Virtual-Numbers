<?php
	...
	// first, figure out the page selector data
        $users_dids =   mysql_fetch_object(mysql_query("SELECT count(*) as total FROM assigned_dids_archieve"))->total;
	...
	$page_vars['my_DIDs'] = $assigned_dids->getBlockArchieveDIDs($_SESSION['user_logins_id'],$page_current_range_start-1);
	...
	//build the page
	$this_page->content_area .= getFraudDetectionArchieveNoticesPage();
